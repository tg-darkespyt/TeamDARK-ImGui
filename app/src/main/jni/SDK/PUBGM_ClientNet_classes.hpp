...
public:
	...
	struct FScriptMulticastDelegate                    OnLoginCommandDelegate;                                   // 0x01A0(0x0010) (ZeroConstructor, InstancedReference)
	...
	int LoginWithCloudGameLoginData();
	...
	struct FString GetCloudGameLoginData();
	struct FString GetChannelNickname();
	struct FString GetBindRetAndUpdateBindRetCode();
	void GetBindInfo();
	int GetBindCount();
