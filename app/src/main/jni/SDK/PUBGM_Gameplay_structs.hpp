...
enum class ECharacterAnimType : uint8_t
{
	...
	ECharAnim_SprintToProne        = 38,
	ECharAnim_OpenDoor             = 39,
	ECharAnim_Shovel               = 40,
	ECharAnim_StandbyIdle          = 41,
	ECharAnim_StandbyIdle01        = 42,
	ECharAnim_ColdStandbyIdle      = 43,
	ECharAnim_ColdStandbyIdle01    = 44,
	ECharAnim_MovementUpBodyOverride = 45,
	ECharAnim_GrenadeLaunchAnim    = 46,
	ECharAnim_GrenadeLaunchReload  = 47,
	ECharAnim_GrenadeLaunchTacticsReload = 48,
	ECharAnim_FillGas              = 49,
	ECharAnim_DropWeapon           = 50,
	ECharAnim_ShoulderWeaponIdle   = 51,
	ECharAnim_BeCarriedBackMove    = 52,
	ECharAnim_BeCarriedBackPickM   = 53,
	ECharAnim_BeCarriedBackPickL   = 54,
	ECharAnim_BeCarriedBackOpenDoor = 55,
	ECharAnim_ScopeBlendAnim       = 56,
	ECharAnim_MovementLowerBodyOverride = 57,
	ECharAnim_Max                  = 58
};
