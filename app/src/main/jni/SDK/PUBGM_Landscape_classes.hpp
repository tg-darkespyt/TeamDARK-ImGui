...
public:
	...
	unsigned char                                      UnknownData09[0x60];                                      // 0x05C8(0x0060) MISSED OFFSET
	bool                                               bHasLandscapeGrass;                                       // 0x0628(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData10[0x3];                                       // 0x0629(0x0003) MISSED OFFSET
	float                                              StaticLightingResolution;                                 // 0x062C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bCastStaticShadow : 1;                                    // 0x0630(0x0001) (Edit)
	unsigned char                                      bCastShadowAsTwoSided : 1;                                // 0x0630(0x0001) (Edit)
	unsigned char                                      bCastFarShadow : 1;                                       // 0x0630(0x0001) (Edit)
	struct FLightingChannels                           LightingChannels;                                         // 0x0631(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      bUseMaterialPositionOffsetInStaticLighting : 1;           // 0x0632(0x0001) (Edit)
	unsigned char                                      bRenderCustomDepth : 1;                                   // 0x0632(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      UnknownData11[0x1];                                       // 0x0633(0x0001) MISSED OFFSET
	int                                                CustomDepthStencilValue;                                  // 0x0634(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	struct FLightmassPrimitiveSettings                 LightmassSettings;                                        // 0x0638(0x0018) (Edit)
	int                                                CollisionMipLevel;                                        // 0x0650(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                SimpleCollisionMipLevel;                                  // 0x0654(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              CollisionThickness;                                       // 0x0658(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData12[0x4];                                       // 0x065C(0x0004) MISSED OFFSET
	struct FBodyInstance                               BodyInstance;                                             // 0x0660(0x0180) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      bGenerateOverlapEvents : 1;                               // 0x07E0(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      bBakeMaterialPositionOffsetIntoCollision : 1;             // 0x07E0(0x0001) (Edit)
	unsigned char                                      bUseHoleConsistent : 1;                                   // 0x07E0(0x0001) (Edit)
	unsigned char                                      UnknownData13[0x3];                                       // 0x07E1(0x0003) MISSED OFFSET
	int                                                ComponentSizeQuads;                                       // 0x07E4(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                SubsectionSizeQuads;                                      // 0x07E8(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                NumSubsections;                                           // 0x07EC(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      bUsedForNavigation : 1;                                   // 0x07F0(0x0001) (Edit)
	unsigned char                                      bMobileMultiLayers : 1;                                   // 0x07F0(0x0001) (Edit)
	ENavDataGatheringMode                              NavigationGeometryGatheringMode;                          // 0x07F1(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bUseLandscapeForCullingInvisibleHLODVertices;             // 0x07F2(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bUseLandscapeVT;                                          // 0x07F3(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData14[0x4];                                       // 0x07F4(0x0004) MISSED OFFSET
	class UTexture2D*                                  MaskTextureUsedByGrassClear;                              // 0x07F8(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData15[0x110];                                     // 0x0800(0x0110) MISSED OFFSET
...
{
public:
	unsigned char                                      UnknownData00[0xA0];                                      // 0x0910(0x00A0) MISSED OFFSET
...
public:
	...
	TArray<struct FIntPoint>                           ProxyComponentBases;                                      // 0x09F8(0x0010) (ZeroConstructor)
	int8_t                                             ProxyLOD;                                                 // 0x0A08(0x0001) (ZeroConstructor, IsPlainOldData)
...
{
public:
	TLazyObjectPtr<class ALandscape>                   LandscapeActor;                                           // 0x0910(0x001C) (Edit, IsPlainOldData)
	bool                                               bLandscapeProxyUseSceenSizeLOD;                           // 0x092C(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
