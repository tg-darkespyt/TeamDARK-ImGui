...
public:
	...
	float                                              FollowSegmentTolerance;                                   // 0x01F4(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	class UCurveFloat*                                 CurveThrottleInput;                                       // 0x01F8(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              MinAngleWhenPivotSteering;                                // 0x0200(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x0204(0x0004) MISSED OFFSET
	class UCurveFloat*                                 CurveThrottleRateWhenTurning;                             // 0x0208(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	class UCurveFloat*                                 CurveSteeringInput;                                       // 0x0210(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bUseBrakeWhenTurning;                                     // 0x0218(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x0219(0x0003) MISSED OFFSET
	float                                              MinRequiredSteeringChange;                                // 0x021C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              MinLengthRateAlmostReach;                                 // 0x0220(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x4];                                       // 0x0224(0x0004) MISSED OFFSET
	class UCurveFloat*                                 CurveBrakeAlmostReach;                                    // 0x0228(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              SteeringThresholdUseBrake;                                // 0x0230(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              SpeedThresholdUseBrake;                                   // 0x0234(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bBlockTest : 1;                                           // 0x0238(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      UnknownData04[0x3];                                       // 0x0239(0x0003) MISSED OFFSET
	float                                              BlockTestingTime;                                         // 0x023C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              BlockSpeedThresholdKMH;                                   // 0x0240(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x4];                                       // 0x0244(0x0004) MISSED OFFSET
	class UClass*                                      DeadInventoryBoxTemplate;                                 // 0x0248(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                DropID;                                                   // 0x0250(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0x4];                                       // 0x0254(0x0004) MISSED OFFSET
	struct FName                                       WrapperBoxName;                                           // 0x0258(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class APlayerTombBox*                              DeadTombBox;                                              // 0x0260(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bDebug;                                                   // 0x0268(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData07[0x3];                                       // 0x0269(0x0003) MISSED OFFSET
	int                                                DebugLevel;                                               // 0x026C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              DebugInterval;                                            // 0x0270(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData08[0x4];                                       // 0x0274(0x0004) MISSED OFFSET
	struct FString                                     BehaviorServiceDebugInfo;                                 // 0x0278(0x0010) (BlueprintVisible, ZeroConstructor)
	unsigned char                                      UnknownData09[0x50];                                      // 0x0288(0x0050) MISSED OFFSET
	class ASTExtraVehicleBase*                         OwnerVehicle;                                             // 0x02D8(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      bCacheMeshOnHit : 1;                                      // 0x02E0(0x0001)
	unsigned char                                      UnknownData10[0x27];                                      // 0x02E1(0x0027) MISSED OFFSET
...
{
public:
	class UCurveFloat*                                 AimDurationCurve;                                         // 0x0308(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	struct FVector2D                                   AimDurationDeviation;                                     // 0x0310(0x0008) (Edit, IsPlainOldData)
	float                                              ShootTurretCD;                                            // 0x0318(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              BulletExplosionRange;                                     // 0x031C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              AimingLockRange;                                          // 0x0320(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              AimingLockRangeWhenFiring;                                // 0x0324(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	struct FVector2D                                   TurretAimRange;                                           // 0x0328(0x0008) (Edit, BlueprintVisible, IsPlainOldData)
	unsigned char                                      bPredictEnemyMove : 1;                                    // 0x0330(0x0001) (Edit)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0331(0x0003) MISSED OFFSET
	struct FVector2D                                   TurretShootRange;                                         // 0x0334(0x0008) (Edit, IsPlainOldData)
	unsigned char                                      bAimingConstantLerp : 1;                                  // 0x033C(0x0001) (Edit)
	unsigned char                                      UnknownData01[0x3];                                       // 0x033D(0x0003) MISSED OFFSET
	float                                              TurretAimingInterpConstantSpeed;                          // 0x0340(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              TurretAimingInterpSpeed;                                  // 0x0344(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              SimTurretAimingInterpConstantSpeed;                       // 0x0348(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              TurretAimingErrorTolerance;                               // 0x034C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bAlsoCheckArcLength : 1;                                  // 0x0350(0x0001) (Edit)
	unsigned char                                      UnknownData02[0x3];                                       // 0x0351(0x0003) MISSED OFFSET
	float                                              ShootTargetLocationOffset;                                // 0x0354(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bTraceBlockShootTargetLocation : 1;                       // 0x0358(0x0001) (Edit)
	unsigned char                                      UnknownData03[0x3];                                       // 0x0359(0x0003) MISSED OFFSET
	int                                                MaxTraceBlockTryTimes;                                    // 0x035C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bResetTurretAfterDestroy : 1;                             // 0x0360(0x0001) (Edit)
	unsigned char                                      bFailedAimingWhenTurretCollided : 1;                      // 0x0360(0x0001) (Edit)
	unsigned char                                      UnknownData04[0x7];                                       // 0x0361(0x0007) MISSED OFFSET
	TMap<float, float>                                 BaseHitRate;                                              // 0x0368(0x0050) (Edit, BlueprintVisible, ZeroConstructor)
	float                                              ShootMGCD;                                                // 0x03B8(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	struct FVector2D                                   ShootMGDuration;                                          // 0x03BC(0x0008) (Edit, IsPlainOldData)
	float                                              ShootMGInterval;                                          // 0x03C4(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	struct FVector2D                                   ShootUpDownRange;                                         // 0x03C8(0x0008) (Edit, IsPlainOldData)
	struct FVector2D                                   ShootLeftRightRange;                                      // 0x03D0(0x0008) (Edit, IsPlainOldData)
	struct FVector2D                                   ShootLeftRightRangeDistance;                              // 0x03D8(0x0008) (Edit, IsPlainOldData)
	struct FVector2D                                   ShootTargetSpeedRange;                                    // 0x03E0(0x0008) (Edit, IsPlainOldData)
	struct FVector2D                                   ShootTargetDistanceRangeDueToSpeed;                       // 0x03E8(0x0008) (Edit, IsPlainOldData)
	struct FVector2D                                   MGShootRange;                                             // 0x03F0(0x0008) (Edit, IsPlainOldData)
	unsigned char                                      bShouldMissOnPurpose : 1;                                 // 0x03F8(0x0001)
	unsigned char                                      bCacheUsingMG : 1;                                        // 0x03F8(0x0001)
	unsigned char                                      bCacheUsingTurret : 1;                                    // 0x03F8(0x0001)
...
public:
	...
	struct FScriptDelegate                             GetDynamicItemDurabilityDelegate;                         // 0x01E8(0x0016) (Edit, ZeroConstructor, InstancedReference)
...
// 0x12D0 (0x14A8 - 0x01D8)
class UAIStateInfoComponentBase : public UAIBasicStateInfoComponent
{
public:
	struct FAIStateInfoBaseMod                         CacheAIStateInfoBaseMod;                                  // 0x01D8(0x0420)
	struct FAIStateInfoBaseMod                         LastAIStateInfoBaseMod;                                   // 0x05F8(0x0420)
	struct FDiffAIStateInfoBaseModGeneral              CacheDiffAIStateInfoBaseModGeneral;                       // 0x0A18(0x0588)
	struct FDiffAIStateInfoBaseMod                     CacheDiffAIStateInfoBaseMod;                              // 0x0FA0(0x03F8)
	bool                                               IsTouchedPlayer;                                          // 0x1398(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x1399(0x0003) MISSED OFFSET
	uint32_t                                           FrameNo;                                                  // 0x139C(0x0004) (ZeroConstructor, IsPlainOldData)
	class ASTExtraPlayerController*                    MyPlayerController;                                       // 0x13A0(0x0008) (ZeroConstructor, IsPlainOldData)
	class AController*                                 OwnerController;                                          // 0x13A8(0x0008) (ZeroConstructor, IsPlainOldData)
	class ANewFakePlayerAIController*                  MyAIController;                                           // 0x13B0(0x0008) (ZeroConstructor, IsPlainOldData)
	class UAIActingComponent*                          AIActingComp;                                             // 0x13B8(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class APawn*                                       MyOwnerPawn;                                              // 0x13C0(0x0008) (ZeroConstructor, IsPlainOldData)
	class ABattleRoyaleGameModeBase*                   MyGameMode;                                               // 0x13C8(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x40];                                      // 0x13D0(0x0040) MISSED OFFSET
	TMap<int, class APickUpWrapperActor*>              CacheAINearbyItem;                                        // 0x1410(0x0050) (ZeroConstructor)
	TArray<class ASTExtraBaseCharacter*>               CacheNearbyEnemies;                                       // 0x1460(0x0010) (ZeroConstructor)
	struct FCacheNearbyItemState                       CacheNearbyItemState;                                     // 0x1470(0x0020)
	class UMLAIControllerComponent*                    MyMLAIControllerComp;                                     // 0x1490(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	uint32_t                                           CacheModeMapId;                                           // 0x1498(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0xC];                                       // 0x149C(0x000C) MISSED OFFSET
...
// 0x0778 (0x1C20 - 0x14A8)
class UAIStateInfoComponentBRBase : public UAIStateInfoComponentBase
{
public:
	struct FAIStateInfoBRBase                          CacheAIStateInfoBRBase;                                   // 0x14A8(0x01D0)
	struct FAIStateInfoBRBase                          LastAIStateInfoBRBase;                                    // 0x1678(0x01D0)
	struct FDiffAIStateInfoBRBaseGeneral               CacheDiffAIStateInfoBRBaseGeneral;                        // 0x1848(0x0250)
	struct FDiffAIStateInfoBRBase                      CacheDiffAIStateInfoBRBase;                               // 0x1A98(0x0188)
...
// 0x01C0 (0x1668 - 0x14A8)
class UAIStateInfoComponentMPBase : public UAIStateInfoComponentBase
{
public:
	struct FAIStateInfoMPBase                          CacheAIStateInfoMPBase;                                   // 0x14A8(0x0090)
	struct FAIStateInfoMPBase                          LastAIStateInfoMPBase;                                    // 0x1538(0x0090)
	struct FDiffAIStateInfoMPBaseGeneral               CacheDiffAIStateInfoMPBaseGeneral;                        // 0x15C8(0x00A0)
...
// 0x00C0 (0x1728 - 0x1668)
class UAIStateInfoComponentTeamDeath : public UAIStateInfoComponentMPBase
{
public:
	struct FAIStateInfoTeamDeath                       CacheAIStateInfoTeamDeath;                                // 0x1668(0x0040)
	struct FAIStateInfoTeamDeath                       LastAIStateInfoTeamDeath;                                 // 0x16A8(0x0040)
	struct FDiffAIStateInfoTeamDeathGeneral            CacheDiffAIStateInfoTeamDeathGeneral;                     // 0x16E8(0x0040)
...
public:
	...
	int                                                NearbyDynamicItemsMaxNum;                                 // 0x0204(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              NearbyMonsterRange;                                       // 0x0208(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                NearbyMonsterMaxNum;                                      // 0x020C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bIgnoreTreeAIWhenNoPlayerAround;                          // 0x0210(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x3];                                       // 0x0211(0x0003) MISSED OFFSET
	float                                              IgnoreTreeAIRadius;                                       // 0x0214(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               UseBodyTPPCamera;                                         // 0x0218(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x7];                                       // 0x0219(0x0007) MISSED OFFSET
	TArray<int>                                        IgnoredMonsterIDs;                                        // 0x0220(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	TArray<EAvatarSlotType>                            AvailableAvatarSlotTypes;                                 // 0x0230(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
...
{
public:
	TMap<uint32_t, struct FMLAIStateInfoBaseMod>       LastAllPlayerStateInfoMap;                                // 0x0040(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FMLAIStateInfoBaseMod>       CurrentAllPlayerStateInfoMap;                             // 0x0090(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FMLAIStateInfoBaseMod>       CacheAllPlayersInfo;                                      // 0x00E0(0x0050) (ZeroConstructor)
	struct FDiffAllMLAIInfoBaseModGeneral              CacheDiffAllPlayersInfoGeneral;                           // 0x0130(0x0100)
	struct FDiffAllMLAIInfoBaseMod                     CacheAllPlayersInfoCSS;                                   // 0x0230(0x00B0)
...
// 0x0808 (0x0848 - 0x0040)
class UBaseStateInfoCollector : public UStateInfoCollectorBase
{
public:
	TMap<uint32_t, struct FAIBaseStateInfo>            LastAllPlayerStateInfoMap;                                // 0x0040(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FAIBaseStateInfo>            CurrentAllPlayerStateInfoMap;                             // 0x0090(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FAIBaseStateInfo>            CacheAllPlayersInfo;                                      // 0x00E0(0x0050) (ZeroConstructor)
	struct FDiffAllPlayerBaseInfoGeneral               CacheDiffAllPlayersInfoGeneral;                           // 0x0130(0x0118)
	struct FDiffAllPlayerBaseInfo                      CacheAllPlayersInfoCSS;                                   // 0x0248(0x03F0)
	struct FGlobalGameBaseState                        CacheGlobalGameState;                                     // 0x0638(0x0060)
	struct FGlobalGameBaseState                        LastGlobalGameState;                                      // 0x0698(0x0060)
	struct FDiffGlobalGameBaseState                    DiffGlobalGameState;                                      // 0x06F8(0x0060)
	struct FDiffGlobalGameBaseStateGeneral             DiffGlobalGameStateGeneral;                               // 0x0758(0x0060)
	TMap<uint32_t, uint32_t>                           DiffStateInfoKeyMap;                                      // 0x07B8(0x0050) (ZeroConstructor)
...
// 0x0B60 (0x0BA0 - 0x0040)
class UBRBaseStateInfoCollector : public UStateInfoCollectorBase
{
public:
	TMap<uint32_t, struct FAIBRBaseStateInfo>          LastAllPlayerStateInfoMap;                                // 0x0040(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FAIBRBaseStateInfo>          CurrentAllPlayerStateInfoMap;                             // 0x0090(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FAIBRBaseStateInfo>          CacheAllPlayersInfo;                                      // 0x00E0(0x0050) (ZeroConstructor)
	struct FDiffAllPlayerBRBaseInfoGeneral             CacheDiffAllPlayersInfoGeneral;                           // 0x0130(0x0100)
	struct FDiffAllPlayerBRBaseInfo                    CacheAllPlayersInfoCSS;                                   // 0x0230(0x04B8)
	struct FGlobalGameBRBaseState                      CacheGlobalGameState;                                     // 0x06E8(0x0108)
	struct FGlobalGameBRBaseState                      LastGlobalGameState;                                      // 0x07F0(0x0108)
	struct FDiffGlobalGameBRBaseState                  DiffGlobalGameState;                                      // 0x08F8(0x0120)
	struct FDiffGlobalGameBRBaseStateGeneral           DiffGlobalGameStateGeneral;                               // 0x0A18(0x0168)
	unsigned char                                      UnknownData00[0x20];                                      // 0x0B80(0x0020) MISSED OFFSET
...
public:
	...
	struct FBlackboardKeySelector                      BBKey_OutBlocked;                                         // 0x00C0(0x0028) (Edit, BlueprintVisible)
	class ABioVehicleBase*                             BioVH;                                                    // 0x00E8(0x0008) (ZeroConstructor, IsPlainOldData)
	class ABioVehicleAIController*                     BioVHAIC;                                                 // 0x00F0(0x0008) (ZeroConstructor, IsPlainOldData)
...
public:
	...
	unsigned char                                      bFilterBuilding : 1;                                      // 0x00D8(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bFilterWater : 1;                                         // 0x00D8(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bReachableTest : 1;                                       // 0x00D8(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bFilterOutBehaviorRegion : 1;                             // 0x00D8(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bFindSpecialSurface : 1;                                  // 0x00D8(0x0001) (Edit, BlueprintVisible)
	TEnumAsByte<enum EPhysicalSurface>                 SurfaceType;                                              // 0x00D9(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bUseNavmesh : 1;                                          // 0x00DA(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      UnknownData01[0x5];                                       // 0x00DB(0x0005) MISSED OFFSET
	struct FName                                       SpecificNaVName;                                          // 0x00E0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<enum ECollisionChannel>                CollisionChannel;                                         // 0x00E8(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x00E9(0x0003) MISSED OFFSET
	float                                              MaxLocationTraceHeightZ;                                  // 0x00EC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
{
public:
	struct FVector                                     JumpTargetPosition;                                       // 0x00B0(0x000C) (Edit, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x00BC(0x0004) MISSED OFFSET
...
{
public:
	float                                              OuterRadiusDeltaValue;                                    // 0x00B0(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              InnerRadiusDeltaValue;                                    // 0x00B4(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              JumpRangeDistance;                                        // 0x00B8(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              MaxTargetPositonDistance;                                 // 0x00BC(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                MaxAttempt;                                               // 0x00C0(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x00C4(0x0004) MISSED OFFSET
...
public:
	...
	class AController*                                 OwnerController;                                          // 0x0290(0x0008) (ZeroConstructor, IsPlainOldData)
	class ANewFakePlayerAIController*                  MyAIController;                                           // 0x0298(0x0008) (ZeroConstructor, IsPlainOldData)
	class ASTExtraPlayerController*                    MyPlayerController;                                       // 0x02A0(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x14];                                      // 0x02A8(0x0014) MISSED OFFSET
	float                                              FindNavLocationRadius;                                    // 0x02BC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                MaxNavLocationFindTimes;                                  // 0x02C0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bUseLerpRotation;                                         // 0x02C4(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x02C5(0x0003) MISSED OFFSET
	float                                              LerpRotationThreshold;                                    // 0x02C8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               IsForceTargetRotation;                                    // 0x02CC(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x3];                                       // 0x02CD(0x0003) MISSED OFFSET
	float                                              FirstLerpRotationDeltaTime;                               // 0x02D0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              FreeCameraTurnVelocity;                                   // 0x02D4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              TurnVelocity;                                             // 0x02D8(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData04[0x4];                                       // 0x02DC(0x0004) MISSED OFFSET
	struct FAIShootingPoseOffsetInfo                   shootingPoseOffsetInfo;                                   // 0x02E0(0x0070) (Edit)
	float                                              AutoOpenDoorRange;                                        // 0x0350(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x8];                                       // 0x0354(0x0008) MISSED OFFSET
	bool                                               IsModifyDamageLuaOverride;                                // 0x035C(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0x3];                                       // 0x035D(0x0003) MISSED OFFSET
	float                                              RatingDamageScaleLuaOverride;                             // 0x0360(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               bShouldSendVehicleInfo;                                   // 0x0364(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData07[0x1B];                                      // 0x0365(0x001B) MISSED OFFSET
	bool                                               IsChangeStatePC;                                          // 0x0380(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData08[0x45F];                                     // 0x0381(0x045F) MISSED OFFSET
...
{
public:
	TMap<uint32_t, struct FAIDynamicItemStateInfo>     LastAllPlayerStateInfoMap;                                // 0x0040(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FAIDynamicItemStateInfo>     CurrentAllPlayerStateInfoMap;                             // 0x0090(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FAIDynamicItemStateInfo>     CacheAllPlayersInfo;                                      // 0x00E0(0x0050) (ZeroConstructor)
	struct FDiffAllPlayerDynamicItemInfoGeneral        CacheDiffAllPlayersInfoGeneral;                           // 0x0130(0x0100)
	struct FDiffAllPlayerDynamicItemInfo               CacheAllPlayersInfoCSS;                                   // 0x0230(0x0130)
	struct FGlobalDynamicItemState                     CacheGlobalGameState;                                     // 0x0360(0x0030)
	struct FGlobalDynamicItemState                     LastGlobalGameState;                                      // 0x0390(0x0030)
	struct FDiffGlobalDynamicItemState                 DiffGlobalGameState;                                      // 0x03C0(0x0050)
	struct FDiffGlobalDynamicItemStateGeneral          DiffGlobalGameStateGeneral;                               // 0x0410(0x0050)
	TMap<uint64_t, struct FDynamicItem>                CacheDynamicItems;                                        // 0x0460(0x0050) (ZeroConstructor)
...
{
public:
	TMap<uint32_t, struct FAIDoorStateInfo>            LastAllPlayerStateInfoMap;                                // 0x0040(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FAIDoorStateInfo>            CurrentAllPlayerStateInfoMap;                             // 0x0090(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FAIDoorStateInfo>            CacheAllPlayersInfo;                                      // 0x00E0(0x0050) (ZeroConstructor)
	struct FDiffAllPlayerDoorInfoGeneral               CacheDiffAllPlayersInfoGeneral;                           // 0x0130(0x0100)
	struct FDiffAllPlayerDoorInfo                      CacheAllPlayersInfoCSS;                                   // 0x0230(0x0130)
	struct FGlobalDoorState                            CacheGlobalGameState;                                     // 0x0360(0x0030)
	struct FGlobalDoorState                            LastGlobalGameState;                                      // 0x0390(0x0030)
	struct FDiffGlobalDoorState                        DiffGlobalGameState;                                      // 0x03C0(0x0050)
	struct FDiffGlobalDoorStateGeneral                 DiffGlobalGameStateGeneral;                               // 0x0410(0x0050)
	TMap<uint64_t, struct FDoorState>                  CacheDoorStates;                                          // 0x0460(0x0050) (ZeroConstructor)
...
{
public:
	TMap<uint32_t, struct FAINearbyMonsterStateInfo>   LastAllPlayerStateInfoMap;                                // 0x0040(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FAINearbyMonsterStateInfo>   CurrentAllPlayerStateInfoMap;                             // 0x0090(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FAINearbyMonsterStateInfo>   CacheAllPlayersInfo;                                      // 0x00E0(0x0050) (ZeroConstructor)
	struct FDiffAllPlayerNearbyMonsterGeneral          CacheDiffAllPlayersInfoGeneral;                           // 0x0130(0x0100)
	struct FDiffAllPlayerNearbyMonsterInfo             CacheAllPlayersInfoCSS;                                   // 0x0230(0x0130)
	struct FGlobalMonsterState                         CacheGlobalGameState;                                     // 0x0360(0x0030)
	struct FGlobalMonsterState                         LastGlobalGameState;                                      // 0x0390(0x0030)
	struct FDiffGlobalMonsterState                     DiffGlobalGameState;                                      // 0x03C0(0x0050)
	TMap<uint64_t, struct FMonsterState>               CacheMonsterStats;                                        // 0x0410(0x0050) (ZeroConstructor)
	struct FDiffGlobalMonsterStateGeneral              DiffGlobalGameStateGeneral;                               // 0x0460(0x0050)
...
{
public:
	TMap<uint32_t, struct FAINearbyPlayerStateInfo>    LastAllPlayerStateInfoMap;                                // 0x0040(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FAINearbyPlayerStateInfo>    CurrentAllPlayerStateInfoMap;                             // 0x0090(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FAINearbyPlayerStateInfo>    CacheAllPlayersInfo;                                      // 0x00E0(0x0050) (ZeroConstructor)
	struct FDiffAllPlayerNearbyPlayerInfoGeneral       CacheDiffAllPlayersInfoGeneral;                           // 0x0130(0x0100)
	struct FDiffAllPlayerNearbyPlayerInfo              CacheAllPlayersInfoCSS;                                   // 0x0230(0x00B0)
...
// 0x0610 (0x0650 - 0x0040)
class UMLAINearbyStateInfoCollector : public UStateInfoCollectorBase
{
public:
	TMap<uint32_t, struct FMLAINearbyStateInfoBaseMod> LastAllPlayerStateInfoMap;                                // 0x0040(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FMLAINearbyStateInfoBaseMod> CurrentAllPlayerStateInfoMap;                             // 0x0090(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FMLAINearbyStateInfoBaseMod> CacheAllPlayersInfo;                                      // 0x00E0(0x0050) (ZeroConstructor)
	struct FDiffAllMLAINearbyInfoBaseModGeneral        CacheDiffAllPlayersInfoGeneral;                           // 0x0130(0x0100)
	struct FDiffAllMLAINearbyInfoBaseMod               CacheAllPlayersInfoCSS;                                   // 0x0230(0x0170)
	struct FGlobalNearbyStateBaseMod                   CacheGlobalGameState;                                     // 0x03A0(0x0050)
	struct FGlobalNearbyStateBaseMod                   LastGlobalGameState;                                      // 0x03F0(0x0050)
	struct FDiffGlobalNearbyStateBaseMod               DiffGlobalGameState;                                      // 0x0440(0x0070)
	struct FDiffGlobalNearbyStateBaseModGeneral        DiffGlobalGameStateGeneral;                               // 0x04B0(0x00B0)
	TMap<uint64_t, struct FItemStateData>              CacheItemData;                                            // 0x0560(0x0050) (ZeroConstructor)
	TMap<uint64_t, struct FAINearbyThrown>             CacheAINearbyThrown;                                      // 0x05B0(0x0050) (ZeroConstructor)
	TMap<uint64_t, struct FObstacleState>              CacheObstacleStates;                                      // 0x0600(0x0050) (ZeroConstructor)
...
public:
	...
	bool                                               bLandingInLowHeight;                                      // 0x0208(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0209(0x0003) MISSED OFFSET
	struct FVector                                     LastLocation;                                             // 0x020C(0x000C) (IsPlainOldData)
	bool                                               bDellJumpToLandExcute;                                    // 0x0218(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bNotiyParachuteComp;                                      // 0x0219(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x6];                                       // 0x021A(0x0006) MISSED OFFSET
	struct FName                                       IgnoreOpen;                                               // 0x0220(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
...
public:
	...
	TMap<struct FString, class UClass*>                CollectorNameToClassMap;                                  // 0x00B0(0x0050) (ZeroConstructor)
	TMap<class ASTExtraPlayerCharacter*, bool>         CacheMLAIs;                                               // 0x0100(0x0050) (ZeroConstructor)
	TMap<class ASTExtraPlayerCharacter*, bool>         CachePlayerAndBTAIs;                                      // 0x0150(0x0050) (ZeroConstructor)
	TMap<uint32_t, bool>                               CacheCandidateAIs;                                        // 0x01A0(0x0050) (ZeroConstructor)
	TMap<uint32_t, bool>                               AlreadySendDeadStateMap;                                  // 0x01F0(0x0050) (ZeroConstructor)
	TMap<uint32_t, int>                                CachePlayerType;                                          // 0x0240(0x0050) (ZeroConstructor)
	TMap<EDiffListIDTag, struct FDiffListIDMap>        DiffPlayerIDToListIDMap;                                  // 0x0290(0x0050) (ZeroConstructor)
	TMap<uint64_t, struct FPropertyNameListIDMap>      DiffAIPlayerInfoListIDMaps;                               // 0x02E0(0x0050) (ZeroConstructor)
	unsigned char                                      UnknownData02[0x20];                                      // 0x0330(0x0020) MISSED OFFSET
...
public:
	...
	unsigned char                                      UnknownData01[0x50];                                      // 0x0138(0x0050) MISSED OFFSET
	TMap<uint32_t, bool>                               AlreadySendDeadStateMap;                                  // 0x0188(0x0050) (ZeroConstructor)
	unsigned char                                      UnknownData02[0x8];                                       // 0x01D8(0x0008) MISSED OFFSET
	struct FRedZoneState                               CacheRedZoneInfo;                                         // 0x01E0(0x0028)
	float                                              AirAttackTotalTime;                                       // 0x0208(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x4];                                       // 0x020C(0x0004) MISSED OFFSET
	class UAirAttackComponent*                         AirAttackComp;                                            // 0x0210(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	struct FGlobalGameStateBRBase                      GlobalGameState;                                          // 0x0218(0x0158)
	struct FGlobalGameStateBRBase                      LastGlobalGameState;                                      // 0x0370(0x0158)
	class UMLAIUtilsBase*                              MlaiUtils;                                                // 0x04C8(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x70];                                      // 0x04D0(0x0070) MISSED OFFSET
	TMap<uint32_t, int>                                CachePlayerRevivalTypes;                                  // 0x0540(0x0050) (ZeroConstructor)
	class UMLAIStateInfoManager*                       MLAIStateInfoManager;                                     // 0x0590(0x0008) (ZeroConstructor, IsPlainOldData)
	int                                                AirDropTag;                                               // 0x0598(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0xC];                                       // 0x059C(0x000C) MISSED OFFSET
	TMap<class AActor*, class ASpecialZoneActor*>      CacheSpecialZoneParents;                                  // 0x05A8(0x0050) (ZeroConstructor)
	unsigned char                                      UnknownData06[0x18];                                      // 0x05F8(0x0018) MISSED OFFSET
...
public:
	...
	struct FGlobalGameStateBaseMod                     CacheGlobalGameStateBaseMod;                              // 0x0190(0x00A0)
	struct FGlobalGameStateBaseMod                     LastGlobalGameStateBaseMod;                               // 0x0230(0x00A0)
	struct FDiffGlobalGameStateBaseMod                 DiffGlobalGameStateBaseMod;                               // 0x02D0(0x00C0)
	struct FDiffGlobalGameStateBaseModGeneral          DiffGlobalGameStateBaseModGeneral;                        // 0x0390(0x0100)
	struct FDiffListIDMap                              DiffPlayerIDToListIDMap;                                  // 0x0490(0x0050)
	TMap<uint64_t, struct FPropertyNameListIDMap>      DiffAIPlayerInfoListIDMaps;                               // 0x04E0(0x0050) (ZeroConstructor)
	TArray<struct FAIStateInfoBaseMod>                 CacheAllPlayersInfoBaseMod;                               // 0x0530(0x0010) (ZeroConstructor)
	struct FDiffAllPlayerInfoBaseModGeneral            CacheDiffAllPlayersInfoBaseModGeneral;                    // 0x0540(0x0098)
	struct FDiffAllPlayerInfoBaseMod                   CacheAllPlayersInfoBaseModCSS;                            // 0x05D8(0x0210)
	TMap<uint32_t, struct FAIStateInfoBaseMod>         LastAllPlayerInfoMapBaseMod;                              // 0x07E8(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FAIStateInfoBaseMod>         CacheAllPlayersInfoMapBaseMod;                            // 0x0838(0x0050) (ZeroConstructor)
	unsigned char                                      UnknownData02[0x40];                                      // 0x0888(0x0040) MISSED OFFSET
	TArray<class ASTExtraPlayerCharacter*>             CacheMLAIs;                                               // 0x08C8(0x0010) (ZeroConstructor)
	TArray<class ASTExtraPlayerCharacter*>             CachePlayerAndBTAIs;                                      // 0x08D8(0x0010) (ZeroConstructor)
...
// 0x0B88 (0x1470 - 0x08E8)
class UMLAIUtilsBRBase : public UMLAIUtilsBase
{
public:
	TMap<uint64_t, struct FDoorState>                  CacheDoorStates;                                          // 0x08E8(0x0050) (ZeroConstructor)
	TMap<uint64_t, struct FVehicleState>               CacheVehicleStates;                                       // 0x0938(0x0050) (ZeroConstructor)
	TMap<uint64_t, struct FDynamicItem>                CacheDynamicItems;                                        // 0x0988(0x0050) (ZeroConstructor)
	TMap<uint64_t, struct FMonsterState>               CacheMonsterStats;                                        // 0x09D8(0x0050) (ZeroConstructor)
	struct FGlobalGameStateBRBase                      CacheGlobalGameStateBRBase;                               // 0x0A28(0x0158)
	struct FGlobalGameStateBRBase                      LastGlobalGameStateBRBase;                                // 0x0B80(0x0158)
	struct FDiffGlobalGameStateBRBase                  DiffGlobalGameStateBRBase;                                // 0x0CD8(0x0120)
	struct FDiffGlobalGameStateBRBaseGeneral           DiffGlobalGameStateBRBaseGeneral;                         // 0x0DF8(0x0238)
	struct FRedZoneState                               CacheRedZoneInfo;                                         // 0x1030(0x0028)
	TArray<struct FAIStateInfoBRBase>                  CacheAllPlayersInfoBRBase;                                // 0x1058(0x0010) (ZeroConstructor)
	struct FDiffAllPlayerInfoBRBaseGeneral             CacheDiffAllPlayersInfoBRBaseGeneral;                     // 0x1068(0x0090)
	struct FDiffAllPlayerInfoBRBase                    CacheAllPlayersInfoBRBaseCSS;                             // 0x10F8(0x0308)
	TMap<uint32_t, struct FAIStateInfoBRBase>          LastAllPlayerInfoMapBRBase;                               // 0x1400(0x0050) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x20];                                      // 0x1450(0x0020) MISSED OFFSET
...
// 0x01B0 (0x0A98 - 0x08E8)
class UMLAIUtilsMPBase : public UMLAIUtilsBase
{
public:
	struct FGlobalGameStateMPBase                      CacheGlobalGameStateMPBase;                               // 0x08E8(0x0030)
	struct FGlobalGameStateMPBase                      LastGlobalGameStateMPBase;                                // 0x0918(0x0030)
	struct FDiffGlobalGameStateMPBaseGeneral           DiffGlobalGameStateMPBaseGeneral;                         // 0x0948(0x0040)
	TArray<struct FAIStateInfoMPBase>                  CacheAllPlayersInfoMPBase;                                // 0x0988(0x0010) (ZeroConstructor)
	struct FDiffAllPlayerInfoMPBaseGeneral             CacheDiffAllPlayersInfoMPBaseGeneral;                     // 0x0998(0x0090)
	TMap<uint32_t, struct FAIStateInfoMPBase>          LastAllPlayerInfoMapMPBase;                               // 0x0A28(0x0050) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x20];                                      // 0x0A78(0x0020) MISSED OFFSET
...
{
public:
	TMap<uint32_t, struct FAIMPStateInfo>              LastAllPlayerStateInfoMap;                                // 0x0040(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FAIMPStateInfo>              CurrentAllPlayerStateInfoMap;                             // 0x0090(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FAIMPStateInfo>              CacheAllPlayersInfo;                                      // 0x00E0(0x0050) (ZeroConstructor)
	struct FDiffAllPlayerMPBaseInfoGeneral             CacheDiffAllPlayersInfoGeneral;                           // 0x0130(0x0110)
	struct FGlobalGameMPState                          CacheGlobalGameState;                                     // 0x0240(0x0030)
	struct FGlobalGameMPState                          LastGlobalGameState;                                      // 0x0270(0x0030)
	struct FDiffGlobalGameBRBaseState                  DiffGlobalGameState;                                      // 0x02A0(0x0120)
	struct FDiffGlobalGameBRBaseStateGeneral           DiffGlobalGameStateGeneral;                               // 0x03C0(0x0168)
...
public:
	...
	class USpecialZoneShapeComponent*                  SpecialZoneShapeComponent;                                // 0x0448(0x0008) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData)
	class AActor*                                      CacheParentActor;                                         // 0x0450(0x0008) (ZeroConstructor, IsPlainOldData)
...
// 0x0090 (0x0888 - 0x07F8)
class AVehicleAIController : public ABasicAIController
{
public:
	class ASTExtraVehicleBase*                         ControlledVehicle;                                        // 0x07F8(0x0008) (ZeroConstructor, IsPlainOldData)
	struct FAIVehicleStateData                         AIVehicleStateData;                                       // 0x0800(0x0080)
	class UAIBehaviorAdapter_VehicleBase*              AIBehaviorAdapter;                                        // 0x0880(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
...
{
public:
	TMap<uint32_t, struct FAIVehicleStateInfo>         LastAllPlayerStateInfoMap;                                // 0x0040(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FAIVehicleStateInfo>         CurrentAllPlayerStateInfoMap;                             // 0x0090(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FAIVehicleStateInfo>         CacheAllPlayersInfo;                                      // 0x00E0(0x0050) (ZeroConstructor)
	struct FDiffAllPlayerVehicleInfoGeneral            CacheDiffAllPlayersInfoGeneral;                           // 0x0130(0x0100)
	struct FDiffAllPlayerVehicleInfo                   CacheAllPlayersInfoCSS;                                   // 0x0230(0x0310)
	struct FGlobalVehicleState                         CacheGlobalGameState;                                     // 0x0540(0x0030)
	struct FGlobalVehicleState                         LastGlobalGameState;                                      // 0x0570(0x0030)
	struct FDiffGlobalVehicleState                     DiffGlobalGameState;                                      // 0x05A0(0x0050)
	struct FDiffGlobalVehicleStateGeneral              DiffGlobalGameStateGeneral;                               // 0x05F0(0x0050)
	TMap<uint64_t, struct FVehicleState>               CacheVehicleStates;                                       // 0x0640(0x0050) (ZeroConstructor)
