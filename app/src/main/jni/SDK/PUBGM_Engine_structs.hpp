...
enum class EMaterialUsage : uint8_t
{
	...
	MATUSAGE_DestructibleHide      = 15,
	MATUSAGE_DestructibleDetach    = 16,
	MATUSAGE_DestructibleSlide     = 17,
	MATUSAGE_MAX                   = 18
};
...
struct FObjectPoolConfig
{
	...
	bool                                               bNeedAutoExpand;                                          // 0x0054(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bEnableForChildClasses;                                   // 0x0055(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
struct FLevelSimplificationDetails
{
	...
	TEnumAsByte<enum ELandscapeCullingPrecision>       LandscapeCullingPrecision;                                // 0x0147(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
};
