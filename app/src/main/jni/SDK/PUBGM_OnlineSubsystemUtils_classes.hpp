...
// 0x0068 (0x356E0 - 0x35678)
class UIpConnection : public UNetConnection
{
public:
	unsigned char                                      UnknownData00[0x68];                                      // 0x35678(0x0068) MISSED OFFSET
...
{
public:
	unsigned char                                      LogPortUnreach : 1;                                       // 0x0640(0x0001) (Config)
	unsigned char                                      AllowPlayerPortUnreach : 1;                               // 0x0640(0x0001) (Config)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0641(0x0003) MISSED OFFSET
	uint32_t                                           MaxPortCountToTry;                                        // 0x0644(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData01[0x18];                                      // 0x0648(0x0018) MISSED OFFSET
	uint32_t                                           ServerDesiredSocketReceiveBufferBytes;                    // 0x0660(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	uint32_t                                           ServerDesiredSocketSendBufferBytes;                       // 0x0664(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	uint32_t                                           ClientDesiredSocketReceiveBufferBytes;                    // 0x0668(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	uint32_t                                           ClientDesiredSocketSendBufferBytes;                       // 0x066C(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData02[0x60];                                      // 0x0670(0x0060) MISSED OFFSET
	float                                              RecreateSocketCooldownTime;                               // 0x06D0(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              RecreateSocketMaxTryCount;                                // 0x06D4(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bResolveRemoteHostOnRecreateSocket;                       // 0x06D8(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bContinueProcessWhenReceiveEmptyPackets;                  // 0x06D9(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bContinueProcessWhenConReceiveEmptyPackets;               // 0x06DA(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData03[0xD];                                       // 0x06DB(0x000D) MISSED OFFSET
