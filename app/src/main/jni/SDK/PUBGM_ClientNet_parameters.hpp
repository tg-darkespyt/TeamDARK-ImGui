...
struct UIMSDKHelper_LoginWithCloudGameLoginData_Params
{
	int                                                ReturnValue;                                              // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};
...
struct UIMSDKHelper_GetCloudGameLoginData_Params
{
	struct FString                                     ReturnValue;                                              // (Parm, OutParm, ZeroConstructor, ReturnParm)
};
...
struct UIMSDKHelper_GetBindRetAndUpdateBindRetCode_Params
{
	struct FString                                     ReturnValue;                                              // (Parm, OutParm, ZeroConstructor, ReturnParm)
};
