...
void ACreativeDestructibleMeshActor::SetDestructibleAction(TEnumAsByte<enum EPhotonFracturedMeshDestructibleAction> Action)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
		pFunc  = UObject::FindObject<UFunction>("Function Creative.CreativeDestructibleMeshActor.SetDestructibleAction");

	ACreativeDestructibleMeshActor_SetDestructibleAction_Params params;
...
void ACreativeDestructibleMeshBatchActor::SetISMStaticMeshAndMaterials(class UInstancedStaticMeshComponent* InstancedStaticMeshComponent, int AssetId, int StaticMeshIndex, int MaterialID)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
		pFunc  = UObject::FindObject<UFunction>("Function Creative.CreativeDestructibleMeshBatchActor.SetISMStaticMeshAndMaterials");

	ACreativeDestructibleMeshBatchActor_SetISMStaticMeshAndMaterials_Params params;
...
struct FCreativeBatchStaticMeshInfo ACreativeDestructibleMeshBatchActor::GetBatchStaticMeshInfo(class UInstancedStaticMeshComponent* InstancedStaticMeshComponent)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
		pFunc  = UObject::FindObject<UFunction>("Function Creative.CreativeDestructibleMeshBatchActor.GetBatchStaticMeshInfo");

	ACreativeDestructibleMeshBatchActor_GetBatchStaticMeshInfo_Params params;
	params.InstancedStaticMeshComponent = InstancedStaticMeshComponent;
...
bool UCreativeInstanceManager::IsEmpowerDestructibleMesh(const struct FString& ID, int* AssetId)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
		pFunc  = UObject::FindObject<UFunction>("Function Creative.CreativeInstanceManager.IsEmpowerDestructibleMesh");

	UCreativeInstanceManager_IsEmpowerDestructibleMesh_Params params;
	params.ID = ID;
...
void UCreativePhotonInstancedDestructibleMeshComponent::SetInstanceDestructionFX(TArray<int> InstanceIndex, TArray<struct FString> FXPath)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
		pFunc  = UObject::FindObject<UFunction>("Function Creative.CreativePhotonInstancedDestructibleMeshComponent.SetInstanceDestructionFX");

	UCreativePhotonInstancedDestructibleMeshComponent_SetInstanceDestructionFX_Params params;
	params.InstanceIndex = InstanceIndex;
	params.FXPath = FXPath;
