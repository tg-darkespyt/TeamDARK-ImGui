...
// 0x0010 (0x1058 - 0x1048)
class ATestAIController : public ABaseAIController
{
public:
	class UClass*                                      EquipedWeaponClass;                                       // 0x1048(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	class UClass*                                      CharacterClass;                                           // 0x1050(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
