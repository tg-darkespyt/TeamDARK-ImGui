...
enum class EBattleItemAdditionalDataType : uint8_t
{
	...
	EBattleItemAdditionalDataType__GunPoint = 32,
	EBattleItemAdditionalDataType__Grip = 33,
	EBattleItemAdditionalDataType__Magazine = 34,
	EBattleItemAdditionalDataType__Gunstock = 35,
	EBattleItemAdditionalDataType__OpticalSight = 36,
	EBattleItemAdditionalDataType__MasterGun = 37,
	EBattleItemAdditionalDataType__Ammo = 38,
	EBattleItemAdditionalDataType__Pendant = 39,
	EBattleItemAdditionalDataType__AngledOpticalSight = 40,
	EBattleItemAdditionalDataType__ACCore = 41,
	EBattleItemAdditionalDataType__Bezel = 42,
	EBattleItemAdditionalDataType__GunLock = 43,
	EBattleItemAdditionalDataType__TacticalAttach = 44,
	EBattleItemAdditionalDataType__EBattleItemAdditionalDataType_MAX = 45
};
...
struct FPickupSetting
{
	...
	TMap<int, int>                                     LimitSeasonItemMap;                                       // 0x01C8(0x0050) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
};
