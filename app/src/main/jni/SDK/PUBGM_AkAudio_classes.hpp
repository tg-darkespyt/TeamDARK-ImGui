...
public:
	...
	TArray<uint16_t>                                   TotalPlayCountRecord;                                     // 0x0050(0x0010) (ZeroConstructor)
	TMap<struct FString, unsigned char>                ObjectPlayCountRecord;                                    // 0x0060(0x0050) (ZeroConstructor)
	TMap<unsigned char, struct FAKErrorInfo>           AkErrorRecord;                                            // 0x00B0(0x0050) (ZeroConstructor)
	struct FScriptMulticastDelegate                    AkAudioEventTrigger;                                      // 0x0100(0x0010) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, InstancedReference)
	float                                              nPassedTime;                                              // 0x0110(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              nUpdateInterval;                                          // 0x0114(0x0004) (ZeroConstructor, IsPlainOldData)
	TMap<struct FString, int8_t>                       BankRefList;                                              // 0x0118(0x0050) (ZeroConstructor)
	TArray<struct FString>                             EventList;                                                // 0x0168(0x0010) (ZeroConstructor)
