...
// Function ClientNet.IMSDKHelper.LoginWithCloudGameLoginData
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// int                            ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)

int UIMSDKHelper::LoginWithCloudGameLoginData()
{
	static UFunction *pFunc = 0;
	if (!pFunc)
		pFunc  = UObject::FindObject<UFunction>("Function ClientNet.IMSDKHelper.LoginWithCloudGameLoginData");

	UIMSDKHelper_LoginWithCloudGameLoginData_Params params;
...
// Function ClientNet.IMSDKHelper.GetCloudGameLoginData
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// struct FString                 ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm)

struct FString UIMSDKHelper::GetCloudGameLoginData()
{
	static UFunction *pFunc = 0;
	if (!pFunc)
		pFunc  = UObject::FindObject<UFunction>("Function ClientNet.IMSDKHelper.GetCloudGameLoginData");

	UIMSDKHelper_GetCloudGameLoginData_Params params;
...
// Function ClientNet.IMSDKHelper.GetBindRetAndUpdateBindRetCode
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// struct FString                 ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm)

struct FString UIMSDKHelper::GetBindRetAndUpdateBindRetCode()
{
	static UFunction *pFunc = 0;
	if (!pFunc)
		pFunc  = UObject::FindObject<UFunction>("Function ClientNet.IMSDKHelper.GetBindRetAndUpdateBindRetCode");

	UIMSDKHelper_GetBindRetAndUpdateBindRetCode_Params params;
