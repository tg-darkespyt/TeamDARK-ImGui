...
// Function Gameplay.UAELevelSequenceActor.IsStartPlayValid
// (Native, Event, Public, BlueprintEvent)
// Parameters:
// bool                           ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)

bool AUAELevelSequenceActor::IsStartPlayValid()
{
	static UFunction *pFunc = 0;
	if (!pFunc)
		pFunc  = UObject::FindObject<UFunction>("Function Gameplay.UAELevelSequenceActor.IsStartPlayValid");

	AUAELevelSequenceActor_IsStartPlayValid_Params params;
