...
public:
	...
	TMap<class UObject*, int>                          InstancedNodeNameToMemoryMap;                             // 0x0638(0x0050) (ZeroConstructor)
	int                                                InstancedNodesTotalSize;                                  // 0x0688(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData08[0x4];                                       // 0x068C(0x0004) MISSED OFFSET
	TArray<struct FString>                             ParentFolderPath;                                         // 0x0690(0x0010) (ZeroConstructor)
	int                                                CurComponentNameIndex;                                    // 0x06A0(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               IsSkillEnabled;                                           // 0x06A4(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData09[0x53];                                      // 0x06A5(0x0053) MISSED OFFSET
	TWeakObjectPtr<class UUTSkillManagerComponent>     SpecificSkillCompRef;                                     // 0x06F8(0x0008) (BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, Transient, InstancedReference, IsPlainOldData)
	TWeakObjectPtr<class UUAEBlackboard>               SpecificBlackBlackRef;                                    // 0x0700(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData)
...
public:
	...
	struct FSkillActiveRepData                         SyncSkillActiveStateDatas;                                // 0x03D8(0x00E0) (Net)
	struct FSkillAttrRepData                           SyncSkillAttrRepData;                                     // 0x04B8(0x00E0) (Net)
	struct FSkillDynamicRepData                        SyncDynamicRepData;                                       // 0x0598(0x00E0) (Net)
	TMap<int, int>                                     IDToSyncSkillCDDatas;                                     // 0x0678(0x0050) (ZeroConstructor)
	TMap<int, int>                                     ButtonSlotToSkillID;                                      // 0x06C8(0x0050) (ZeroConstructor)
	struct FTeammateSkillCDRepData                     TeammateSkillCDRepData;                                   // 0x0718(0x0010)
	TArray<struct FSkillCDRepData>                     SyncSkillCDDatas;                                         // 0x0728(0x0010) (Net, ZeroConstructor)
	unsigned char                                      UnknownData04[0x88];                                      // 0x0738(0x0088) MISSED OFFSET
	struct FUTSkillHitInfo                             SkillHitInfo;                                             // 0x07C0(0x0030) (Net)
	struct FUTSkillHitEnvInfo                          SkillHitEnvInfo;                                          // 0x07F0(0x0030)
	TArray<struct FString>                             MutexMontageGroupBeenPlayed;                              // 0x0820(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData05[0x4];                                       // 0x0830(0x0004) MISSED OFFSET
	int                                                SkillSynRandomSeed;                                       // 0x0834(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FRandomStream                               SkillSynRandStream;                                       // 0x0838(0x0008)
	int                                                SkillSynRandomSeedExpireCount;                            // 0x0840(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0xC];                                       // 0x0844(0x000C) MISSED OFFSET
	TArray<struct FSkillParamater>                     SkillParamaters;                                          // 0x0850(0x0010) (Net, ZeroConstructor)
	struct FScriptMulticastDelegate                    OnSkillInitSignature;                                     // 0x0860(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    SkillStartEvent;                                          // 0x0870(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    SkillStopEvent;                                           // 0x0880(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    SkillPhaseChangeEvent;                                    // 0x0890(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    SkillLevelChangeEvent;                                    // 0x08A0(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    SkillSkinIDChangeEvent;                                   // 0x08B0(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    SkillUpdateCDEvent;                                       // 0x08C0(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	TArray<int>                                        PendingRemoveSkillID;                                     // 0x08D0(0x0010) (ZeroConstructor)
	TArray<struct FUTReplaceSkillData>                 ReplacedSkillDatas;                                       // 0x08E0(0x0010) (BlueprintVisible, Net, ZeroConstructor)
	TMap<int, struct FSkillDisableKeySet>              DisableSkillTagsMap;                                      // 0x08F0(0x0050) (ZeroConstructor)
	struct FMultiSkillSynData                          NewSkillSynData;                                          // 0x0940(0x00F0) (BlueprintVisible, Net)
	struct FSkillSinglePhaseData                       NewSkillSinglePhaseData;                                  // 0x0A30(0x00F0) (BlueprintVisible, Net)
	TMap<uint64_t, struct FUTSkillSimulateData>        SkillSimulateDataMap;                                     // 0x0B20(0x0050) (ZeroConstructor)
	unsigned char                                      UnknownData07[0x50];                                      // 0x0B70(0x0050) UNKNOWN PROPERTY: SetProperty Skill.UTSkillManagerComponent.AsyncLoadingSkillInst
	struct FUTSkillExecQueue                           SkillExecQueue;                                           // 0x0BC0(0x00B0)
	uint64_t                                           NetClientSimulateInstID;                                  // 0x0C70(0x0008) (Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData08[0x10];                                      // 0x0C78(0x0010) MISSED OFFSET
...
public:
	...
	TMap<struct FName, struct FString>                 ActionParams;                                             // 0x0170(0x0050) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	bool                                               bEnableLuaPrivateData;                                    // 0x01C0(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x7];                                       // 0x01C1(0x0007) MISSED OFFSET
	struct FString                                     LuaFilePath;                                              // 0x01C8(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
...
{
public:
	class UUTSkillAction*                              Action;                                                   // 0x01D8(0x0008) (Edit, BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	bool                                               bDefaultDoAction;                                         // 0x01E0(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bDefaultUpdateAction;                                     // 0x01E1(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bDefaultResetAction;                                      // 0x01E2(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bDefaultUndoAction;                                       // 0x01E3(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
{
public:
	struct FSkillFuncNameSelector                      DoActionFuncKey;                                          // 0x00B0(0x0010) (Edit, BlueprintVisible)
	struct FSkillFuncNameSelector                      ResetActionFuncKey;                                       // 0x00C0(0x0010) (Edit, BlueprintVisible)
	struct FSkillFuncNameSelector                      UndoActionFuncKey;                                        // 0x00D0(0x0010) (Edit, BlueprintVisible)
