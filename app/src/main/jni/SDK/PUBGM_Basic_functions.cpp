...
class UDataTableProxy* UTableManagerSubsystem::GetTableProxy(const struct FName& tableName, bool bTempory)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
...
class UDataTableProxy* UUAETableManager::GetDataTableProxy(const struct FName& tableName, bool bTempory)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
